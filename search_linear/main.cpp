...
// Function to perform benchmarking and execute linear search on a given array
void searchArray(int arr[], int size, int target) {
    // Print array (no need to sort for linear search)
    ...
    cout << "Linear Search execution time: " << duration << " nanoseconds" << endl;
}
